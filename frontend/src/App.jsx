      ...
      <div className="w-full max-w-xl mx-auto space-y-6">
        ...
        {plan && (
          <div className="space-y-4">
            ...
            <Card label="Meal"     icon="🍽" value={plan.meal}     agent="PreferenceAgent" model={models?.preference_model} />
            <Card label="Route"    icon="🗺" value={plan.route}    agent="LogisticsAgent"  model={models?.logistics_model} />
            <Card label="Priority" icon="📌" value={plan.priority} agent="ScheduleAgent"   model={models?.schedule_model} />
